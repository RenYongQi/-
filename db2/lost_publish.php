...
<div class="container">
    ...
    <div class="row clearfix">
		<div class="col-md-12 column">
			<form role="form" method="post" action="/db2/lost_ok.php">
				...
				<div class="form-group">
					 <label for="named">联系人</label><input type="text" class="form-control" name="named" class="form-control" id="named" required />
					<p class="help-block">
						丢失人姓名
					</p>
				</div>
